      ...
      <header data-thq="thq-navbar" className="navbar8-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          ...
          <nav className="navbar8-links1">
            <a
              href="#" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
            >
              {props.link1 ?? (
                <Fragment>
            ...
            <a href="#" onClick={() => { const currentScroll = window.scrollY; const scrollPosition = window.innerHeight * 2; if (currentScroll < scrollPosition) { window.scrollBy({ top: scrollPosition - currentScroll, behavior: 'smooth' }); } }} className="thq-link thq-body-small" >
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text16">#basic-set-concepts</span>
                </Fragment>
              )}
            </a>
            <a
              href="#" onClick={() => window.scrollBy({ top: window.innerHeight * 3, behavior: 'smooth' })}
              // target="_blank"
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text24">#set-operations</span>
                </Fragment>
              )}
            </a>
            <div
            ...
            >
              <span className="thq-link thq-body-small">
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar8-text21">#quiz</span>
                  </Fragment>
                )}
              </span>
          ...
          <div className="navbar8-buttons1">
            ...
            >
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text15">Start Learning</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action21 thq-button-outline thq-button-animated" onClick={() => window.scrollBy({ top: window.innerHeight * 9.5, behavior: 'smooth' })}>
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text27">Take Quiz</span>
                  </Fragment>
                )}
              </span>
            </button>
                            ...
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text26">
                                  Practice set operations like union,
                      ...
                      <div className="navbar8-menu-item4">
                        ...
                        <div className="navbar8-content4">
                          <span className="navbar8-page41 thq-body-large">
                            {props.page4 ?? (
                              <Fragment>
                                <span className="navbar8-text19">Quiz</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                ...
                <div className="navbar8-menu-item7">
                  ...
                  <div className="navbar8-content7">
                    <span className="navbar8-page32 thq-body-large">
                      {props.page3 ?? (
                        <Fragment>
                          <span className="navbar8-text25">Set Operations</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                      {props.page3Description ?? (
                        <Fragment>
                          <span className="navbar8-text26">
                            Practice set operations like union, intersection,
                            and difference.
                          </span>
                        </Fragment>
                      )}
...
Navbar8.defaultProps = {
  ...
  page1ImageSrc:
    'https://images.unsplash.com/photo-1578305035108-429188b9ede6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMTAwNTc3N3w&ixlib=rb-4.0.3&q=80&w=1080',
  action1: undefined,
  page2ImageAlt: 'Basic Set Concepts Image',
  link2: undefined,
  //linkUrlPage2: 'https://www.teleporthq.io',
  logoAlt: 'Sets Learning Module Logo',
  logoSrc:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/84ec08e8-34e9-42c7-9445-d2806d156403/fac575ac-7a41-484f-b7ac-875042de11f8?org_if_sml=1&force_format=original',
  page3ImageAlt: 'Set Operations Image',
  //linkUrlPage1: 'https://www.teleporthq.io',
  page1: undefined,
  link1: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1497015289639-54688650d173?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMTAwNTc3OHw&ixlib=rb-4.0.3&q=80&w=1080',
  //linkUrlPage3: 'https://www.teleporthq.io',
  page4: undefined,
  page2: undefined,
  link4: undefined,
  page4ImageAlt: 'Quiz Image',
  page1Description: undefined,
  page2ImageSrc:
    'https://images.unsplash.com/photo-1616089804112-f0a475d1b193?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMTAwNTc3OXw&ixlib=rb-4.0.3&q=80&w=1080',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1677078611286-4d023c913878?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMTAwNTc3OXw&ixlib=rb-4.0.3&q=80&w=1080',
